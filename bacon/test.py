...
def test_tiny_acted_together_0(): 
    actor1 = 2876
    actor2 = 1640
    actor3 = 1532
    assert lab.acted_together(db_tiny, actor1, actor2) is True
    assert lab.acted_together(db_tiny, actor2, actor2) is True
    assert lab.acted_together(db_tiny, actor3, actor2) is False
########################################
...
#########################
####### Self-Written ###############
def test_tiny_actor_to_actor_path_0():
    expected = len([2876, 1532])
    result = len(lab.actor_to_actor_path(db_tiny, 2876, 1532))
    assert result == expected
